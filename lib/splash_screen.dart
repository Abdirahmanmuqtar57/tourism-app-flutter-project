      ...
      body: Column(
        children: [
          ...
          Row(
            children: [
              SizedBox(width: 110,),
              Text(" Made With ", style: TextStyle(color: Colors.white, fontSize: 18),),
          ...
          Row(children: [
            SizedBox(width: 160,),
            Text("By Abdirahman", style: TextStyle(color: Colors.white, fontSize: 15, decoration: TextDecoration.underline),)
          ],)
          // SizedBox(height: 40,),
          // Row(
          //   children: [
